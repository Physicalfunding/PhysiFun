...
/**
 * ProjectCreateForm コンポーネント
 * プロジェクト新規作成用のフォーム
 *
 * 機能:
 * - タイトル、概要、詳細説明、カテゴリ、開催場所の入力
 * - バリデーションエラーの表示
 * - 作成後、プロジェクト編集ページへリダイレクト
 */
export function ProjectCreateForm() {
  ...
  /**
   * フォーム送信処理
   * プロジェクト作成APIを呼び出し、成功時はマイプロジェクトページへ遷移
   */
    ...
    <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
      ...
      <div>
        ...
        <textarea
          ...
          rows={3}
          className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-orange-500 focus:border-orange-500"
          placeholder="プロジェクトの概要を簡潔に記述してください"
        />
      ...
      <div>
        ...
        <textarea
          ...
          rows={8}
          className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-orange-500 focus:border-orange-500"
          placeholder="プロジェクトの背景、目的、期待される成果などを詳しく記述してください"
        />
        {errors.description && (
